...
const FEEDS = [
  ...
  { url: 'https://api.foxsports.com/v1/rss',                                   source: 'Fox Sports'             },
  { url: 'https://www.si.com/rss/si_sbnation.rss',                             source: 'Sports Illustrated'     },
  { url: 'https://nbcsports.com/rss',                                          source: 'NBC Sports'             },
  { url: 'https://www.usatoday.com/sports/rss/',                               source: 'USA Today Sports'       },
  { url: 'https://nypost.com/sports/feed/',                                    source: 'NY Post Sports'         },
  { url: 'https://deadspin.com/rss',                                           source: 'Deadspin'               },
  { url: 'https://www.theguardian.com/sport/rss',                              source: 'The Guardian Sport'     },
  { url: 'https://theathletic.com/nba/feed/',                                  source: 'The Athletic NBA'       },
  { url: 'https://theathletic.com/nfl/feed/',                                  source: 'The Athletic NFL'       },
  { url: 'https://theathletic.com/mlb/feed/',                                  source: 'The Athletic MLB'       },
];
