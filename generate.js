...
async function generatePicks() {
  ...
  const prompt = `You are a sharp sports bettor with real-time knowledge. Today is ${today}. Search the web for the most imminent upcoming games across NBA, MLB, NHL, MLS, and any other major sport. Prioritize games happening today, then tonight, then tomorrow — always find the most upcoming games available regardless of day.

For each game research: current injury reports and player availability, recent ATS records and team form (last 5-10 games), back-to-back schedules, home/away performance splits, line movement and sharp money indicators, weather for outdoor games, any roster news or coaching changes.

Always find 3-4 picks. Never return an empty list — if today has no good spots, use tomorrow or the next available games. Pick the most imminent games with the clearest edges.
  ...
  "picks": [
    {
      ...
      "pick": "Team A -4.5",
      "odds": "-110",
      "edge": "Specific reason citing real data: e.g. Team B is 2-8 ATS on road, missing Bam Adebayo (ankle, out), on 2nd night of back-to-back",
      "confidence": "high"
    }
  ]
}

Rules: confidence = high, medium, or low. 3-4 picks only. Each edge must cite specific verifiable facts — injury reports, ATS records, schedule spots. No vague reasoning. Always return 3-4 picks.`;
