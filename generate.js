  ...
  for (let attempt = 1; attempt <= 3; attempt++) {
    res = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        // Cluster output runs ~5-7k tokens (6-8 articles + sidebar + deals + etc).
        // 4000 truncates and breaks JSON parsing; 14000 is wasteful headroom.
        // 7000 fits the real output with a small safety margin.
        max_tokens: 7000,
