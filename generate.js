...
const FEEDS = [
  ...
  { url: 'https://www.bbc.co.uk/sport/american-football/rss.xml',   source: 'BBC NFL'              },
...
async function fetchFeed(feed) {
  try {
    ...
    console.warn(`FAIL ${feed.source}: ${e.message}`);
    return [];
  }
}
