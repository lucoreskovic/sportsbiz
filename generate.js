...
Also return poll: a single timely poll based on the biggest story or theme in today's news. Format: { question: "...", options: ["...", "...", "...", "..."] }. The question should be opinionated and engaging, e.g. "Will the Padres' $3.9B sale price become the new normal for MLB franchises?" Options should be 3-4 short, distinct answers.
