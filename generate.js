...
Return ONLY valid JSON. Top-level keys: clusters, draftTracker, deals, ratings, ticket_prices, sidebar, poll, predictions, picks, updatedAt.
  ...
  for (let attempt = 1; attempt <= 3; attempt++) {
    res = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        // Cluster output with the trimmed prompt (5-7 clusters, 220-300 word
        // articles, 6 sidebar items at 100-150 words) typically fits in 4-5k.
        // 5500 gives a safety margin without paying for unused headroom.
        max_tokens: 5500,
